...
const SidebarItem = ({ id, name, icon, description }: SidebarItemProps) => {
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            ref={drag}
            className={`flex flex-col items-center justify-center p-2 rounded-lg cursor-grab transition-all bg-[#430045] hover:bg-[#7e0084] ${
